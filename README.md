...
### 🔗 [Uygulamayı aç →](https://vanaciltip.me/veah-klinik-karar-destek/)
...
**Web üzerinden:** https://vanaciltip.me/veah-klinik-karar-destek/ adresinden doğrudan açabilirsiniz. Kurulum gerekmez.
...
- Yayın adresi **HTTPS** üzerinden sunulmaktadır (Let's Encrypt sertifikası, GitHub Pages tarafından otomatik yenilenir). `www.` ön ekli adres sertifika kapsamında olmadığı için `https://vanaciltip.me/...` biçimini kullanınız.
